var Inbox = function () {
	...
	/*	Show Inbox view
	/*-----------------------------------------------------------------------------------*/
	var showInbox = function (el, name,url) {
       var url = 'inbox_main';
        main_content.html('');
        toggleButton(el);
        $.ajax({
        ...
        $.ajax({
            ...
            success: function(result, request) {
                ...
                if(parsedData.status ==='success'){
                    toggleButton(el);
                    $('.emailContent').html(parsedData.data);
                    showWYSIWYG();
                    handleCCBCC();
                    $('#editor').focus();
                    App.initUniform();
            ...
            success: function(result, request) {
                ...
                if(parsedData.status ==='success'){
                   // alert(parsedData.data);
                    //console.log('hete');
                    //main_content.empty();
                    //main_content.html(parsedData.data);
                    $('.emailContent').html(parsedData.data);
                }
    ...
    return {
        init: function () {
			...
			$('#del_messagge').click(function(){
			var object = $('input[type=checkbox]:checked');
